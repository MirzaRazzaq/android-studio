package com.example.collegealarm;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textAlarm = findViewById(R.id.alarm);
        buttonSetDialog = findViewById(R.id.btnStart);
    ...
    TimePickerDialog.OnTimeSetListener onTimeSetListener = new TimePickerDialog.OnTimeSetListener(){
        ...
        @Override
        public void onTimeSet(TimePicker timePicker, int hourOfDary, int minute) {
            Calendar calNow = Calendar.getInstance();
            Calendar calSet = (Calendar) calNow.clone();
            calSet.set(Calendar.HOUR_OF_DAY, hourOfDary);
